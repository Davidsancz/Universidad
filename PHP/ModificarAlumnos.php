  ...
  <body>
    ...
    <div class="container mt-5">
                <form action="../PHP/ActuAl.php" method="POST">
                    ...
                    <input type="text"class="form-control mb-3" name="Carrera" placeholder="Carrera"value="">
                    <input type="text"class="form-control mb-3" name="Turno" placeholder="Turno"value="">

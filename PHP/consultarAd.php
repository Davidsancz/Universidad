<?php
    ...
    $ConsultarAl= "SELECT * FROM administrativoss";
                            ...
                            <div class="col-12">
                                <table class="table mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        ?> 
                                            <tr>
                                              <td><?php echo $row['IdAdmi'];?></td>
                                              <td><?php echo $row['Nombre'];?></td>
                                              <td><?php echo $row['Sueldo'];?></td>
                                              <td><?php echo $row['Area'];?></td>
                            
                                              <td><a class="btn btn-info" href="ActAdmi.php?IdAdmi=<?php echo $row['IdAdmi'];?>">
                                              Edit</a>&nbsp; <a class="btn btn-danger" href="eliminarAd.php?IdAdmi=<?php echo $row['IdAdmi'];?>">
                                              Delete</a>
                                              </td>
                                            <tr>
                                              <?php

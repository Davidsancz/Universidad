<?php
    ...
    $ConsultarAl= "SELECT * FROM profesoress";
    $result= $conn->query($ConsultarAl);
                            ...
                            <div class="col-12">
                                <table class="table mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        ?> 
                                            <tr>
                                              <td><?php echo $row['IdProf'];?></td>
                                              <td><?php echo $row['Nombre'];?></td>
                                              <td><?php echo $row['Sueldo'];?></td>
                                              <td><?php echo $row['Materia'];?></td>
                            
                                              <td><a class="btn btn-info" href="ModificarAlumnos.php?IdProf=<?php echo $row['IdProf'];?>">
                                              Edit</a>&nbsp; <a class="btn btn-danger" href="eliminarPro.php?IdProf=<?php echo $row['IdProf'];?>">
                                              Delete</a>
                                              </td>
                                            <tr>
                                              <?php

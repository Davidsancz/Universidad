<?php
    ...
    $ConsultarAl= "SELECT * FROM alumnoss";
                                    ...
                                    <tbody>
                                        ...
                                        ?> 
                                            <tr>
                                              ...
                                              <td><a class="btn btn-info" href="ModificarAlumnos.php?IdAlumno=<?php echo $row['IdAlumno'];?>">
                                              Edit</a>&nbsp; <a class="btn btn-danger" href="EliminarAl.php?IdAlumno=<?php echo $row['IdAlumno'];?>">
                                              Delete</a>
                                              </td>
                                            <tr>
                                              <?php
